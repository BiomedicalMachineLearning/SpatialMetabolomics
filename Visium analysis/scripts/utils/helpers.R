...
getRawSpatialPaths <- function(prefix='', suffix=''){
  ...
  raw_paths <- c('Visium94_A1_Hybrid_treated/', 'Visium94_B1_Hybrid_treated/', 
...
loadGeneSets <- function(load_gsea_v2=T, load_SHH=T,
  ...
  if (load_gsea_v2) {
    ...
    terms_v2 <- c("HALLMARK_E2F_TARGETS","GOBP_NEUROTRANSMITTER_TRANSPORT","GOBP_NEURON_DIFFERENTIATION")
