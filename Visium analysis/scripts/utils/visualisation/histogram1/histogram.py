...
import sys
import numpy
scripts_path = '/scratch/user/uqqvo1/Medulloblastoma_analysis/scripts/utils/'
sys.path.append(scripts_path)
from utils1 import inputHelpers as input
from interfaces import visualisation as interface
